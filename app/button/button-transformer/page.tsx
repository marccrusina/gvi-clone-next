...
import type { ApiButtonData } from '@/components/button/types/button'
import {
  transformButtonProps,
  transformMultipleButtonProps,
} from '@/components/button/utils/button-transformer'
    ...
    <DemoPageWrapper>
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ color: '#6b7280' }}>
          Educational examples using GrandVision-realistic API structures and
          button patterns
        </p>
      </div>
      ...
      >
        ...
        <p style={{ color: '#6b7280', marginBottom: '16px' }}>
          Real GrandVision content module with product, service, and support
          buttons
        </p>
        ...
        >
          <div>
            ...
            >
              ...
              <li>
                • <code>style</code> - GrandVision button styles
                (cta-fill-primary, etc.)
              </li>
              <li>
