...
export default function ButtonTransformerPage() {
  ...
  // Example 2: CMS Teaser Module (LXTeaser type)
  ...
  // Example 4: Store Locator Button (like in actual CMS)
  const storeLocatorButton: ApiButtonData = {
    ...
    target: {
      type: 'CMExternalPage',
      title: 'Trova il tuo negozio CMS',
      formattedUrl: '/trova-negozi',
      openInNewWindow: false,
    },
  }

  // Example 5: Real CMS Content Module Buttons
  const contentModuleButtons: ApiButtonData[] = [
    ...
    {
      // External service link (common in CMS)
      ...
      target: {
        type: 'CMExternalPage',
        title: 'Supporto CMS',
        formattedUrl: 'https://support.example.it',
        openInNewWindow: true,
      },
    },
    {
      // Eye test booking (core CMS service)
  ...
  const transformedContentModuleButtons =
    transformMultipleButtonProps(contentModuleButtons)
  ...
  const examples = [
    ...
    },
    {
      ...
      description: 'Button with CMS callToAction structure',
      apiData: collectionButton,
      transformed: transformedCollectionButton,
    },
    {
      title: 'CMS Store Locator',
      description: 'Store locator button with CMS target structure',
    ...
    <DemoPageWrapper>
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ color: '#6b7280' }}>
          Educational examples using CMS-realistic API structures and button
          patterns
        </p>
      </div>
      ...
      >
        ...
        >
          Multiple Buttons (CMS Content Module)
        </h2>
        <p style={{ color: '#6b7280', marginBottom: '16px' }}>
          Real CMS content module with product, service, and support buttons
        </p>
      ...
      >
        ...
        >
          <div>
            ...
            >
              <li>
                • <code>callToActionText</code> - Button text from CMS
              </li>
              <li>
                • <code>callToActionEnabled</code> - Button visibility flag
              </li>
              <li>
                • <code>style</code> - CMS button styles (cta-fill-primary,
                etc.)
              </li>
              <li>
                • <code>target.formattedUrl</code> - Navigation URL
              </li>
              <li>
                • <code>target.type</code> - Page type (CMSPage, ProductPage,
                etc.)
              </li>
              <li>
                • <code>target.openInNewWindow</code> - External link behavior
              </li>
              <li>
                • <code>elementId</code> - Analytics tracking identifier
              </li>
              <li>
                • <code>formattedUrl</code> - Direct URL (fallback)
              </li>
            </ul>
          </div>
          <div>
            ...
            >
              <li>
                • <code>variant</code> - primary, secondary, tertiary,
                quaternary
              </li>
              <li>
                • <code>fillType</code> - fill, outline
              </li>
              <li>
                • <code>size</code> - small, medium, big
              </li>
              <li>
                • <code>fullwidth</code> - boolean
              </li>
              <li>
                • <code>external</code> - boolean
              </li>
              <li>
                • <code>to</code> - string or LinkProps object
              </li>
              <li>
                • <code>dataElementId</code> - tracking identifier
              </li>
            </ul>
          </div>
        </div>
